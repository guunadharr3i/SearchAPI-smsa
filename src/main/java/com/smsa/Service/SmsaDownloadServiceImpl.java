 ...
 * @author abcom
 */
@Service("smsa_download")
public class SmsaDownloadServiceImpl implements SmsaDownloadService{

    private static final Logger logger = LogManager.getLogger(SmsaDownloadServiceImpl.class);
